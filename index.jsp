		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 me-auto">
					<p class="lead">Create your profile and send in your quries, change the icon in the dividers, and add your email
						address to the contact form to make it fully functional!
					    I am a full stack developer and I develope mobile applications in both Android and IOS.</p>
				</div>
			</div>
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">What is freelancing</h4>
					<p class="lead mb-0">
						Freelance, freelancer, or freelance worker, are terms commonly used for a person who is self-employed and not necessarily committed to a particular employer long-term.</a> .
					</p>
				</div>
			</div>
		</div>
